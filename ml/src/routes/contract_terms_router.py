...
@router.post(
    ...
    **출력:**
    ...
    """,
    responses={
        200: {"description": "특약사항 생성 성공", "model": ContractResponse},
...
async def create_special_terms(contract_input: ContractInput) -> ContractResponse:
    ...
    try:
        ...
        response = ContractResponse(
            success=True, message="특약사항이 성공적으로 생성되었습니다.", data=result
        )
...
async def validate_contract_input(contract_input: ContractInput):
    ...
    validation_result = {"valid": True, "messages": [], "suggestions": []}
